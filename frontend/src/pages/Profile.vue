<script setup>
    ...
    const profileImageUrl = computed(() => {
        if (!aboutPage.value?.expand?.picture?.file) return null;
    ...
    const loadData = async () => {
        try {
            ...
            // 載入關於頁面（含圖片）
            const pageData = await pb
                .collection('pages')
                .getFirstListItem('slug="about"', {
                    expand: 'picture',
                });
...
<template>
    <div class="flex flex-col min-h-screen">
        ...
        >
            ...
            >
                <div
                    class="animate-spin rounded-full h-32 w-32 border-b-2 border-blue-500 mx-auto"
                ></div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            >
                                ...
                                <div
                                    v-else
                                    class="w-32 h-32 mx-auto mb-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center"
                                >
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                class="w-16 h-16 mx-auto mb-2 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center"
                                            >
                                                <span
                                                    class="text-blue-600 dark:text-blue-300 font-bold text-xs"
                                                >
                                                    {{
